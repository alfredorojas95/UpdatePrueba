...
public class DirectorDAO {
	...
	public static boolean save(orm.Director director) throws PersistentException {
		try {
			orm.EntidadRelacionPruebaPrograPersistentManager.instance().saveObject(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Director director) throws PersistentException {
		try {
			orm.EntidadRelacionPruebaPrograPersistentManager.instance().deleteObject(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Director director)throws PersistentException {
		try {
			...
			orm.Curso[] lCursos = director.curso.toArray();
			for(int i = 0; i < lCursos.length; i++) {
				lCursos[i].setDirector(null);
			}
	...
	public static boolean refresh(orm.Director director) throws PersistentException {
		try {
			orm.EntidadRelacionPruebaPrograPersistentManager.instance().getSession().refresh(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Director director) throws PersistentException {
		try {
			orm.EntidadRelacionPruebaPrograPersistentManager.instance().getSession().evict(director);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
