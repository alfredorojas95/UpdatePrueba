...
public class EntidadRelacionPruebaPrograPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EntidadRelacionPruebaProgra";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EntidadRelacionPruebaPrograPersistentManager();
		}
